<div class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
   <div class="container-fluid">
      ...
      <form action="{{url('bulk-upload-data-exe')}}" id="bulkUploadForm" enctype="multipart/form-data" method="post">
         @csrf
         <div class="row">
            ...
            <div class="col-md-6 mb-3">
               ...
               <select id="ptype" name="product_type" class="form-control" required="required">
            ...
            <div class="col-md-6 mb-3">
               ...
               <select name="country" id="countryDD" required="" class="form-control">
                  <option value="">Select Country</option>
               </select>
            </div>
            <div class="col-md-6 mb-3">
               <label class="d-block control-label">Upload File</label>
               <input name="datafile" id="bulkupload" type="file" class="form-control">
            </div>
...
<script>
   $("select#ptype").change(function (e) { 
      e.preventDefault();
      let ptypeVal = $(this).val();
      $.ajax({
         type: "GET",
         url: "{{url('countries-for-category-id')}}",
         data: {
            "product_type" : $(this).val()
         },
         success: function (response) {
            $("select#countryDD").html('<option value="">Select Country</option>');
            $("select#countryDD").append(response);
         }
      });
   });

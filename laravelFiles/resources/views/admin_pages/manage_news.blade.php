    ...
    <div class="table-responsive">
       <table id="example" class="table table-striped table-bordered DataTable" style="width:100%">
          ...
          <tbody>
            <tr>
               <td>1</td>
               <td>Vijaynagar Emperor Tirumala Raya issued gold Pagoda depicting Lord Rama and Sita seated with Lakshmana</td>
               <td>Jai Shri Ram! The New #RamMandir in #Ayodhya, #Uttar Pradesh, is a sacred site for Hindui..</td>
               <td>  
                  <img src="https://s3-ap-southeast-1.amazonaws.com/mint-news/vijaynagar-emperor-tirumala-raya-fold-pagoda-depicting-lord-rama.jpg" alt="" class="img-fluid" style="width:75px">
               </td>
               <td>2024-01-22</td>
               <td>  
               ...
               <td>
                  <button type="button" class="btn btn-secondary btn-sm align-self-baseline" data-bs-toggle="modal" data-bs-target="#EditNews" title="Edit"><i class="fa fa-edit"></i></button>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body"> 
         <div class="row">
            ...
            <div class="col-md-12 mb-3">
               <label class="control-label">Discription</label>
               <div class=""> <textarea name="Edit_News_Discription" id="Edit_News_Discription" class="form-control"  rows="10">
Jai Shri Ram!<br><br>

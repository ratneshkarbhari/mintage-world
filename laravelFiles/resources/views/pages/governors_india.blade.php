             ...
             <div class="col-lg-9 col-md-12 mt-md-5 mt-0 mt-lg-0">
                <div class="knowledge-base-contetnt">
                   ...
                   <div class="row">
                      ...
                      <div class="col-lg-3 col-md-4 col-6">
                         <div class="box1 governor">
                            <img src="https://www.mintageworld.com/img/governer_images/urjit-patel.jpg" class="img-fluid" alt="Urjit Patel">	
                            <a href="#">
                               <div class="box-governor">Urjit Patel</div>
                               <div class="year">04-09-2016 To 10-12-2018</div>
                            </a>
                         </div>
                      </div>
                      <div class="col-lg-3 col-md-4 col-6">
                         <div class="box1 governor">
                            <img src="https://www.mintageworld.com/img/governer_images/Shaktikanta_Das_12-12-2018_To__In-office_.jpg" class="img-fluid" alt="Shaktikanta Das">	
                            <a href="#">
                               <div class="box-governor">Shaktikanta Das</div>
                               <div class="year">12-12-2018 To (In-Office)</div>
                            </a>
                         </div>
                      </div>
                   </div>

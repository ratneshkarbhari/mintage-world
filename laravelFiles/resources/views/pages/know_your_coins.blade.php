        ...
        <div class="container-fluid px-lg-2 px-lg-5">
            <nav aria-label="breadcrumb" class="breadcrumb-title-box">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item me-2">Know Your Coins</li>                    
                </ol>
            </nav>
        </div>
    </section>    
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12 mt-md-5 mt-0 mt-lg-0">
                    <div class="knowledge-base-contetnt">
                        ...
                        <p>Over the course of history, many rulers and dynasties have come and gone. Each has issued coins; sometimes bearing different designs. The ruler’s name or an epithet is usually minted on the coin barring some ancient coins. The obverse and reverse of the coins bear different devices. The legend on Indian coins are inscribed in Brahmi, Kharoṣṭhī, Greek, Arabic, Telugu, Kannada, Nagari and Sharada among other scripts. Modern coins may bear a security edge.</p>
                        <div class="row knowledge-img-list align-items-center">
                            <div class="col-md-3 col-6">
                                <img src="{{url("assets/img/minted.jpg")}}" class="img-fluid">
                                <h5>Punch-Mark Coins</h5>
                            </div>
                            <div class="col-md-3 col-6">
                                <img src="{{url("assets/img/Menander.jpg")}}" class="img-fluid"> 
                                <h5>Silver Coin issued by Menander</h5>
                            </div>
                            <div class="col-md-3 col-6">
                                <img src="{{url("assets/img/Meharabi.jpg")}}" class="img-fluid">  
                                <h5>Mehrabi Coin issued by Akbar</h5>
                            </div>
                            <div class="col-md-3 col-6">
                                <img src="{{url("assets/img/Modern_coins.jpg")}}" class="img-fluid">   
                        ...
                        <p>Republic Indian coins depict the essence of India today. Motifs such as ears of corn, the Indian Parliament, the map of India, the National Emblem and the Rhinoceros can be seen on coins. The various motifs on coins issued in India display the cultural impact of the period.</p> 
                      
                        <h5><b>How are coins minted?</b></h5> 
                        <p>Coins are made from metal. The metal is first heated. The molten metal is then beaten into sheets. Planchets or coin blanks are cut from these sheets and the stamped with the chosen motif. There are 4 ways in which Indian coins have been minted over time.</p>
                        <ul class="simple-list">
                            <li>Punch Mark Technique</li>
                            <li>Cast Technique</li>
                        ...
                        <h5><b>Collections and Auctions</b></h5> 
                        <p>Coin collectors usually focus on dynasties, rulers or types. A collection is complete if it includes coins of the same type belonging to different rulers or a coin of each type issued by a ruler or the dynasty. Coin collecting differs from Numismatics as it does not include studying the currency, but only collecting it. A numismatist may or may not be a coin collector and a collector may or may not be a numismatist.</p>
                        <p>Numerous numismatic auction houses have been catering to the numismatic community for a while now. They are the ones to go to if you wish to add a rare coin to your collection or start one. Common coins can be found with all coin dealers, however, rare coins are usually found only with auction houses. Auction houses have coin catalogues to help you identify and choose the coin you would like to buy. It is not, however, similar to a coin shop. If you wish to buy a coin from the auction house, you will be required to place a bid. The auctions may be conventional, silent or online. Almost all auction houses have established their presence on the internet and collectors and enthusiasts are able to place their bids from around the world at the click of a button.</p>

                     ...
                     <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 <td>{{$member_address['tag']}}</td>
                                 <td>{{$member_address['first_name']}} {{$member_address['last_name']}}</td>
                                 <td>
                                    {{$member_address["address"]}}<br>
                                    {{$member_address["city"]}},{{$member_address["state"]}}, {{$member_address["zip"]}}<br>
                                 ...
                                 <td>
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#delete-address-{{$member_address['id']}}">
                                       <i class="fa fa-trash"></i></button>
                                 </td>
                              </tr>
                              <div class="modal fade" id="delete-address-{{$member_address['id']}}" tabindex="-1" aria-labelledby="Delete-Address" aria-hidden="true">
                                          ...
                                          <form class="update-additional-address-form" action="{{url('update-additional-address')}}/" method="post">
                                                ...
                                                <div class="row">
                                                   <div class="col-md-6 mb-3">
                                                      ...
                                                      <input type="text" name="first_name" class="form-control" id="inputName" placeholder="Name" maxlength="20" pattern="[A-Za-z]{0,20}" title="Enter only character / Max. limit is 20" value="{{$member_address['first_name']}}" required>                                                      
                                                   </div>
                                                   <div class="col-md-6 mb-3">
                                                      <label for="last_name">Last Name</label>
                                                      <input name="last_name" type="text" class="form-control" id="lastName" maxlength="20" pattern="[A-Za-z]{0,20}" title="Enter only character / Max. limit is 20" value="{{$member_address['last_name']}}" required>                                                      
                                                   </div>
                                                   <div class="col-md-4  mb-3">
                                                      <label for="inputMobileNo">Mobile No</label>
                                                      <input type="text" class="form-control" id="inputMobileNo" name="mobile" placeholder="Mobile No" minlength="10" maxlength="10" title="Enter Only Indian 10 Digits Mobile No"  pattern="[6-9]{1}[0-9]{9}" value="{{$member_address['mobile_number']}}" required>                                                      
                                                   </div>
                                                   <div class="col-md-12  mb-3">
                                                      <label for="inputAddress">Address</label>
                                                      <textarea name="address" class="form-control" cols="30" rows="5">{{$member_address['address']}}</textarea>
                                                   </div>
                                                   <div class="col-md-6  mb-3">
                                                      <label for="inputCity">City</label>
                                                      <input type="text" class="form-control" id="inputCity" name="city" placeholder="City" value="{{$member_address['city']}}" required>
                                                   </div>
                                                   <div class="col-md-6  mb-3">
                                                   ...
                                                   <div class="col-md-6  mb-3">
                                                      ...
                                                      <input type="number" class="form-control" id="inputZip" placeholder="Zip Code" maxlength="6" minlength="6" pattern="[0-9]*" title="Only 6 Digit" name="pincode" value="{{$member_address['zip']}}" required>
                                                   </div>
                                                   <div class="col-md-6  mb-3">

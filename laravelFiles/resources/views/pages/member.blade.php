        ...
        <div class="container-fluid  px-lg-2 px-lg-5">
            ...
            <div class="row login-form-content text-start">
                ...
                <div class="col-md-8 col-xs-12 col-sm-12 login_form "> 
                   <form id="RegForm" action="{{url('registration-exe')}}" class="registrationForm" method="POST" class="form-group">
                        ...
                        @csrf    
                            ...
                            <input type="text" id="first_name" name="first_name" class="form__input mb-0 mt-0"
                                title="Min. 4 to Max. 20 characters" minlength="4" maxlength="20" required="">
                            <p class="error-message text-danger mb-3"></p>
                            <label for="" class="w-100 mb-0"><b>Last Name</b></label>
                            <input type="text" id="last_name" name="last_name" class="form__input mb-0 mt-0"
                                title="Min. 4 to Max. 20 characters" minlength="4" maxlength="20" required="">
                            <p class="error-message text-danger mb-3"></p>
              ...
              <div class="d-block position-relative mb-0 mt-2 password-div">
                        ...
                        <input type="password" id="NewPassword" name="p2" class="form__input mb-0 mt-0 passwordFields"  title="" placeholder="" required="">
...
// var message = document.getElementsByClassName("error-message");
// var regex = /^/;
// if (newpassword == " " || newpassword.match(numbers)) {
//     text = "";
//     message[4].innerHTML = text;
//     return true;
// }

<main class="page-content">   
   ...
   <section class="home-page-carousel">
      <div class="owl-carousel header-carousel position-relative">
         <div class="owl-carousel-item position-relative">
            <a href="https://www.mintageworld.com/view-product/834-history-of-one-rupee-note/"><img src="https://www.mintageworld.com/img/shopping_slider/one-rupee-celebration.jpg" class="img-fluid" alt=""></a> 
         </div>
         <div class="owl-carousel-item position-relative">
            <a href="https://www.mintageworld.com/view-product/808-mintage-coin-collection-album-for-5-rupees-definitive-coins/"><img src="https://www.mintageworld.com/img/shopping_slider/album-shopping.jpg" class="img-fluid" alt=""></a> 
         </div>
         <div class="owl-carousel-item position-relative">
            <a href="https://www.mintageworld.com/shop/list/2-collectibles-accessories/"><img src="https://www.mintageworld.com/img/shopping_slider/slider-shopping.jpg" class="img-fluid" alt=""></a> 
         </div>
         <div class="owl-carousel-item position-relative">
            <a href="https://www.mintageworld.com/shop/#section-carousel"><img src="https://www.mintageworld.com/img/shopping_slider/slider3.jpg" class="img-fluid" alt=""></a> 
         </div>
         <div class="owl-carousel-item position-relative">
            <a href="https://www.mintageworld.com/shop/list/19-buy-banknotes/"><img src="https://www.mintageworld.com/img/shopping_slider/slider4.jpg" class="img-fluid" alt=""></a> 
         </div>
         <div class="owl-carousel-item position-relative">
            <a href="https://www.mintageworld.com/shop/list/22-stamps/"><img src="https://www.mintageworld.com/img/shopping_slider/slider5.jpg" class="img-fluid" alt=""></a> 
         </div>
         <div class="owl-carousel-item position-relative">
            <a href="https://www.mintageworld.com/shop/list/18-buy-coins/"><img src="https://www.mintageworld.com/img/shopping_slider/slider6.jpg" class="img-fluid" alt=""></a> 
         </div>
      </div>
   </section>
   <!-- Carousel End --> {{-- 
   ...
   <section class="common-padding coing-list-wraper">
      <div class="container-fluid  px-lg-2 px-lg-5">
         ...
         <div class="d-flex justify-content-between">
            <h2 class="mb-3 heading-1">Shop</h2>
         </div>
         --}} 
               ...
               <div id="CategoryMenu" class="category-menu">
                  <nav class="nav" role="navigation">
                     ...
                     <ul class="nav__list">
                           ...
                           <ul class="group-list">
                              <li class="active">
                                 ...
                                 <ul class="sub-group-list">
                                    <li class="active"><a href="https://www.mintageworld.com/shop/list/29-ancient/">Ancient</a> </li>
                                    <li class="active"><a href="https://www.mintageworld.com/shop/list/30-medieval/">Medieval</a> </li>
                                    <li class="active"><a href="https://www.mintageworld.com/shop/list/31-indian-princely-state/">Indian Princely State</a> </li>
                                    <li class="active"><a href="https://www.mintageworld.com/shop/list/32-colonial/">Colonial</a> </li>
                                    <li class="active">
                           ...
                           <ul class="group-list">
                              <li>
                                 ...
                                 <ul class="sub-group-list">
                                    ...
                                    <li><a href="https://www.mintageworld.com/shop/list/51-coin-storage-box/">Coin Storage Box</a> </li>
                                 </ul>
                              </li>
                              <li>
                        ...
                        <li> <input type="checkbox" hidden=""> <label><a href="https://www.mintageworld.com/shop/list/23-books/">Numismatic Books</a></label> </li>
                     </ul>
                  </nav>
               </div>
            </div>
   ...
   <section class="common-padding page-footer-disc bg-light-wraper">
      <div class="container-fluid px-lg-2 px-lg-5">
         ...
         <p>Mintage World offers a unique online shopping portal for collectors where you can choose from a wide range of exciting products. You can now buy banknotes online and select from a <a href="https://www.mintageworld.com/shop/list/19-buy-banknotes/">collection of beautiful paper money</a> from the world with just a few clicks. The buy coins section gives you a chance to enhance your collection with some very interesting coins from India as well as the world. To top it, these products also come with detailed descriptions about the coin and its history. What more could you have asked! The <a href="https://www.mintageworld.com/shop/list/16-buy-stamps/">collection of stamps</a> offers philatelists and stamp lovers a wide range of colourful items based on various amazing themes. </p>

    ...
    <section class="common-padding noteg-list-wraper">
        <div class="container-fluid px-lg-2 px-lg-5">
            ...
            <div class="row info-item-grid-row">
                ...
                @if($period["image"]!="")
                <div class="col-lg-2 col-md-6 col-6 info-item-grid-outer-box"><a href="{{url("stamp/dynasty/".$period["id"]."-".Str::slug(strtolower($period["title"])))}}">
                ...
                @else
                <div class="col-lg-2 col-md-6 col-6 info-item-grid-outer-box"><a href="{{url("stamp/dynasty/".$period["id"])}}">
